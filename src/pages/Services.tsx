                ...
                <div className="service-top-wrapper">
                    ...
                    <div className="service-text-2">
                        ...
                        <ul>
                            ...
                            <li>{isGerman ? "✯ Prototyp entwickeln: Es entsteht ein Prototyp – ein grober Entwurf der zukünftigen Webanwendung. Sie erhalten die Basisversion des Projekts." : "✯ Prototyping: A prototype – A rough draft of the future web application will be created. You will get the basic version of the project."}</li>
                            <li>{isGerman ? "✯ Design: Das Farbschema wird ausgewählt und das Grundlayout festgelegt. Das Erscheinungsbild der Elemente wird unter Berücksichtigung aller Anforderungen und Besonderheiten Ihrer Wahrnehmung und der Ihrer Nutzer gestaltet." : "✯ Design: The color scheme  will be selected and the basic layout will be decided. The appearance of the elements will be formed, considering all the requirements and peculiarities of you and your users’ perception."}</li>
                            ...
                            <li>{isGerman ? "✯ Support: Betreuung der Anwendung, Verfeinerung vorhandener Funktionen oder Hinzufügen neuer Funktionen basierend auf Ihren Zielen und dem Feedback der Benutzer." : "✯ Support: Maintaining the application, refining the existing features, or adding new ones based on your objectives and the feedback from the users."}</li>       
                        </ul>
                    </div>
                </div>     
             </div>  
